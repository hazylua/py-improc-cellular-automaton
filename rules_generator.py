...
import json
from matrix_patterns import rotate_90_degree_clckwise, x_symmetry, y_symmetry, diagl_symmetry, diagr_symmetry, get_matrix, get_pattern, rotate_180_degree_clckwise, rotate_270_degree_clckwise, identity
...
def get_rules(arr, s):
    """ Get all rules for configuration. """
